...
// Fetch income details grouped by source only
$query = "SELECT source, SUM(amount) AS total FROM income WHERE user_id = ? GROUP BY source";
...
while ($row = $result->fetch_assoc()) {
    $dataArray[] = "['" . $row['source'] . "', " . $row['total'] . "]";
}
