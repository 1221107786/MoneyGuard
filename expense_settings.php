...
$sql = "SELECT date, amount, category, payment_method FROM expenses WHERE user_id = ?";
...
<body>
    ...
    <div class="sidebar">
        ...
        <button onclick="location.href='add_expense.php'"><i class="ri-dashboard-line"></i>Add Expense</button>
        <button onclick="location.href='edit_expense.php'"><i class="fas fa-edit"></i>Edit Expense</button>
        <button onclick="location.href='delete_expense.php'"><i class="fas fa-trash-alt"></i>Delete Expense</button>
        <button onclick="location.href='profile.php'"><i class="fas fa-user"></i>View Dashboard</button>
    </div>
    <div class="content">
